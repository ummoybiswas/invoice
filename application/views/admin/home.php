                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="even gradeC">
                                            ...
                                            <td><?=$bill->date?></td>
                                            <td class="center"><?=$bill->due_date?></td>
                                            <td class="center"><?=$bill->total_bill?></td>
											<td><?=$bill->due?></td>
											<td>
												<button type="button" class="btn btn-primary btn-circle" title="Update Bill"><i class="fa fa-check"></i>
												</button>
												<a href="<?php echo base_url();?>index.php/admin/view_bill/<?=$bill->bill_id?>"><button type="button" class="btn btn-warning btn-circle" title="View Bill"><i class="fa fa-eye"></i>
												</button></a>
...
<!-- Mirrored from binarycart.com/bclivedemos/01-05-2014/v1/bs-binary-admin/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 22 Dec 2015 10:03:31 GMT -->
</html>
