                ...
                <div class="">
                        ...
                        <div class="x_panel">
                                <div class="x_title">
                                    ...
                                    <h1><i class="fa fa-user"></i> Create New Admin </h1>
                            ...
                            <form  action="<?php echo site_url('admin/insert_new_admin');?>" method="post" id="demo-form" data-parsley-validate="" enctype="multipart/form-data">
                                    <div class="x_content ">  
                                     <div class="col-md-6">
                                       <label for="first_name">First Name :</label>
                                        ...
                                        <input  id="address2"   class="form-control" name="address2"  type="text"><ul id="parsley-id-0979" class="parsley-errors-list"></ul>
										
										<label for="sold">Profile Picture:(max-width:1024,max-height:780,max-weight:2 MB)</label>
										<input id="input-21" type="file" name="userfile"  accept="image/*" class="file-loading btn btn-default">
                                    ...
                                    <div class="col-md-6">
                                       ...
                                       <label for="zip">Zip Code :</label>
                                        ...
                                        <select  id="dept" class="form-control" required name="dept">
										{dept}
										<option value="{dept_id}">{dept_name}</option>
										{/dept}
                                        </select>
                                         
                                         <span style="margin-top:4px;display:block;color:blue"><label for="privilege"><h2>Give All privilege!</h2></label>
                                         <input type="checkbox" id="privilege" class="flat" name="is_admin"  value="1"></span>
