                ...
                <div class="">
                        ...
                        <div class="x_panel">
                            ...
                            <form novalidate="" action="<?php echo site_url('admin/insert_new_client_data');?>" method="post" id="demo-form" data-parsley-validate="">
                                        ...
                                        <input  id="email"  class="form-control" name="email" data-parsley-trigger="change"  required="" type="email"><ul id="parsley-id-5214" class="parsley-errors-list"></ul>
                                ...
                                <div class="x_content ">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input  id="uname"  class="form-control" name="uname" required="" type="text"><ul id="parsley-id-0979" class="parsley-errors-list"></ul>           
                                    </div>
                                
                                    <div class="col-md-6">
                                        <label for="pass">Password :</label>
                                        <input  id="pass"  class="form-control" name="pass" required="" type="password"><ul id="parsley-id-0979" class="parsley-errors-list"></ul>           
                                    </div>
                                
                                <br>
                                    <button style="border:none;background:none"><span class="btn btn-primary pull-right">Sign UP</span></button>
                            </form>
