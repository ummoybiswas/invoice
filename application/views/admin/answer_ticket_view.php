                        ...
                        <div class="container">
						 <div class="x_content">
								...
								<div class="col-md-12 col-lg-12 col-sm-7">
						             ...
						             <?php 
										foreach ($t_info_client_single as $value) 
										{  if( $value['reply_type']==1){
                                            ...
                                            <?php
													   ...
													   else{ if($value['date_time_ans']!=null && $value['ans_message']!=null){ ?>
									 ...
									 <?php } ?>	
									  <blockquote class="blockquote-reverse">
													...
													<form id="demo-form" data-parsley-validate="" action="<?php echo site_url('admin/submit_answer');?>" method="post">
														<textarea id="message" required="required" class="form-control" name="admin_reply" data-parsley-trigger="keyup"
														...
														<br>
															...
															<button type="submit" class="btn btn-success">Submit to Reply</button>
												    </form>
